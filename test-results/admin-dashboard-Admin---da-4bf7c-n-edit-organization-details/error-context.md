...
- Name: admin-dashboard.spec.ts >> Admin - dashboard and organization >> admin can edit organization details
- Location: Sprint-2&3-Tests\specs\admin-dashboard.spec.ts:35:7
