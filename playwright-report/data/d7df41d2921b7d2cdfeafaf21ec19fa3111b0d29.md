...
- Name: specs\admin-users.spec.ts >> Admin - user management flow >> admin can add user and see updated list
- Location: tests\specs\admin-users.spec.ts:58:7
...
```ts
  ...
  10  |     await page.goto('http://localhost:3000/dashboard/admin/users');
  11  |   });
  12  | 
