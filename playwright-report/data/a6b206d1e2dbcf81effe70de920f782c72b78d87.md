...
- Name: specs\admin-dashboard.spec.ts >> Admin - dashboard and organization >> admin can see organization details on dashboard
- Location: tests\specs\admin-dashboard.spec.ts:27:7
...
```ts
  ...
  8  |     await page.goto('http://localhost:3000/dashboard/admin');
  9  |   });
  10 | 
