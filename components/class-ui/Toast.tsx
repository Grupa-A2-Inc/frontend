...
export default function Toast({ message, type, onClose }: Props) {
  ...
  return (
    <div className={`fixed bottom-24 right-6 z-[99999] flex items-center gap-3 rounded-2xl px-5 py-3.5 shadow-2xl border text-sm font-semibold transition-all animate-float ${
      isSuccess 
