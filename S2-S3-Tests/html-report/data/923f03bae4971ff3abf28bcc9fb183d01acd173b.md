...
- Name: admin-classes.spec.ts >> Admin - classroom management flow >> admin can navigate to classrooms page and see list state
- Location: e2e\specs\admin-classes.spec.ts:23:7
