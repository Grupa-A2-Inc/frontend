...
- Name: teacher-course-editor.spec.ts >> Teacher – Course Editor Page >> can assign course to a classroom
- Location: e2e\specs\teacher-course-editor.spec.ts:86:7
...
Call log:
  - waiting for locator('select').first()
    - locator resolved to <select class="w-full rounded-xl border border-brand-border bg-brand-bg p-2 text-sm text-brand-text outline-none disabled:cursor-not-allowed disabled:opacity-60 md:max-w-sm">…</select>
      ...
      - main [ref=e22]:
        - generic [ref=e23]:
          ...
          - generic [ref=e36]:
            ...
            - button "Students Classes, students, results, and access" [active] [ref=e43]:
              - img [ref=e45]
              - generic [ref=e48]:
            ...
            - generic [ref=e63]:
              - generic [ref=e64]:
                ...
                - generic [ref=e75]:
                  - generic [ref=e76]:
                    - img
                    - textbox "Search student..." [ref=e77]
                  - combobox [ref=e78]:
                    - option "Name / email" [selected]
                    - option "Progress"
