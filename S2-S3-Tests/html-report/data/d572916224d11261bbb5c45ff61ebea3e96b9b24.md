  ...
  - generic [ref=e2]:
    ...
    - generic [ref=e6]:
      ...
      - generic [ref=e9]:
        ...
        - paragraph [ref=e18]: "could not execute statement [ERROR: duplicate key value violates unique constraint \"refresh_token_token_hash_key\" Detail: Key (token_hash)=(21a7ad3d64fda34197ac694f058ea0744d8d39c3e4dfa23b2e47979a5fb7bc8b) already exists.] [insert into refresh_token (created_at,expires_at,revoked_at,token_hash,user_id,id) values (?,?,?,?,?,?)]; SQL [insert into refresh_token (created_at,expires_at,revoked_at,token_hash,user_id,id) values (?,?,?,?,?,?)]; constraint [refresh_token_token_hash_key]"
