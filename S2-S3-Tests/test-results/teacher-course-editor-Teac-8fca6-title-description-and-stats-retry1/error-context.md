...
- Name: teacher-course-editor.spec.ts >> Teacher – Course Editor Page >> loads course header with title, description and stats
- Location: e2e\specs\teacher-course-editor.spec.ts:15:7
...
Locator: getByText('Loading course details...')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Loading course details...')
