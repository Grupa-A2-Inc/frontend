...
Call log:
  ...
  - waiting for getByRole('link', { name: /edit/i }).first()
    14 × locator resolved to <a href="/dashboard/teacher/courses/7f71e64b-2bf3-4578-9eb5-a8fc07a85657/edit" class="rounded-xl border border-brand-border bg-brand-card px-4 py-2 text-sm font-semibold text-brand-text shadow-sm transition hover:bg-brand-bg">Edit course</a>
